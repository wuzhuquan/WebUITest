package com.xmd.plugins.arrow;

import com.xmd.plugins.arrow.utils.ConfigReader;
...
public class PowerEmailableReporter implements IReporter {
	...
	public void generateSuiteSummaryReport(List<ISuite> suites) {
		...
		m_out.print("<tr>");
		tableColumnStart("Num");
		tableColumnStart("Test");
//		tableColumnStart("Methods<br/>Passed");
//		tableColumnStart("Scenarios<br/>Passed");
		tableColumnStart("Passed");//将Methods<br/>Passed修改为了Passed
		tableColumnStart("# skipped");
		tableColumnStart("# failed");
		tableColumnStart("Total");
		tableColumnStart("Percent");
